...
export default function Home() {
	...
	return (
		...
		>
			<div className="min-h-screen flex flex-col">
				<div className="flex-1 mt-20 flex items-center justify-center">
					<div className="max-w-6xl text-center mx-auto mb-4">
						<h1 className="justify-center px-8 mx-auto text-5xl font-bold text-teal-300 mb-8">
			...
			<div className="max-w-6xl text-center px-6 mx-auto mt-4 mb-12">
			...
			<div className="max-w-6xl text-center px-6 mx-auto mb-12">
